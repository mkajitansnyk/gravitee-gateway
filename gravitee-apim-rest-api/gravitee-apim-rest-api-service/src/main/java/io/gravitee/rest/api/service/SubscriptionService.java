...
public interface SubscriptionService {
    ...
    SubscriptionEntity restore(String subscription, ExecutionContext executionContext);

    SubscriptionEntity close(ExecutionContext executionContext, String subscription);

    void delete(String subscription, ExecutionContext executionContext);

    Collection<SubscriptionEntity> search(SubscriptionQuery query, ExecutionContext executionContext);
