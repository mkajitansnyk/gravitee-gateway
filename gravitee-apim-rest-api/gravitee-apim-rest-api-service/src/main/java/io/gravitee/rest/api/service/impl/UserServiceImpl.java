...
public class UserServiceImpl extends AbstractService implements UserService, InitializingBean {
    ...
    private void checkUserRegistrationEnabled(ExecutionContext executionContext, GraviteeContext.ReferenceContext currentContext) {
     ...
     */
    @Override
    public UserEntity finalizeRegistration(
        ExecutionContext executionContext,
        GraviteeContext.ReferenceContext currentContext,
        ...
        try {
            ...
            if (USER_REGISTRATION.name().equals(action)) {
                checkUserRegistrationEnabled(executionContext, currentContext);
