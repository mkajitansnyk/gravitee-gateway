        ...
        if (userId != null) {
            ...
            if (portal) {
                ...
                if (!applications.isEmpty()) {
                    ...
                    final Collection<SubscriptionEntity> subscriptions = subscriptionService.search(query, executionContext);
    ...
    public void delete(ExecutionContext executionContext, String apiId) {
        try {
            ...
            if (optApi.get().getLifecycleState() == LifecycleState.STARTED) {
                ...
                subscriptions.forEach(sub -> subscriptionService.delete(sub.getId(), executionContext));
