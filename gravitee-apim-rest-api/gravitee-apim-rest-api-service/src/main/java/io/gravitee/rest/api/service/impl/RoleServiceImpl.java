...
public class RoleServiceImpl extends AbstractService implements RoleService {
    ...
    @Override
    public RoleEntity create(ExecutionContext executionContext, final NewRoleEntity roleEntity, String organizationId) {
        try {
            ...
            if (entity.isDefaultRole()) {
                toggleDefaultRole(executionContext, roleEntity.getScope(), entity.getName(), organizationId);
            }
            return entity;
        } catch (TechnicalException ex) {
    ...
    public RoleEntity update(ExecutionContext executionContext, final UpdateRoleEntity roleEntity, final String organizationId) {
        ...
        try {
            ...
            if (entity.isDefaultRole()) {
                toggleDefaultRole(executionContext, scope, entity.getName(), organizationId);
            }
            return entity;
        } catch (TechnicalException ex) {
    ...
    private void toggleDefaultRole(ExecutionContext executionContext, RoleScope scope, String newDefaultRoleName, String organizationId)
    ...
    public void initialize(ExecutionContext executionContext, String organizationId) {
        ...
        this.create(executionContext, DEFAULT_ROLE_ORGANIZATION_USER, organizationId);

        LOGGER.info("     - <ENVIRONMENT> API_PUBLISHER");
        this.create(executionContext, ROLE_ENVIRONMENT_API_PUBLISHER, organizationId);

        LOGGER.info("     - <ENVIRONMENT> USER (default)");
        this.create(executionContext, DEFAULT_ROLE_ENVIRONMENT_USER, organizationId);

        LOGGER.info("     - <API> USER (default)");
        this.create(executionContext, DEFAULT_ROLE_API_USER, organizationId);

        LOGGER.info("     - <API> OWNER");
        this.create(executionContext, ROLE_API_OWNER, organizationId);

        LOGGER.info("     - <API> REVIEWER");
        this.create(executionContext, ROLE_API_REVIEWER, organizationId);

        LOGGER.info("     - <APPLICATION> USER (default)");
        this.create(executionContext, DEFAULT_ROLE_APPLICATION_USER, organizationId);

        LOGGER.info("     - <APPLICATION> OWNER");
        this.create(executionContext, ROLE_APPLICATION_OWNER, organizationId);
    }
