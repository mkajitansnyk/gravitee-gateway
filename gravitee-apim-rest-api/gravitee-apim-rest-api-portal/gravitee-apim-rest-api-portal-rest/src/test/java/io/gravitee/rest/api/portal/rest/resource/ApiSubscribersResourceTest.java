...
public class ApiSubscribersResourceTest extends AbstractResourceTest {
    ...
    public void shouldGetApiSubscribersAsPrimaryOwner() {
        ...
        subC1.setApi(API);
        doReturn(Arrays.asList(subB1, subC1, subA1)).when(subscriptionService).search(any(), eq(GraviteeContext.getExecutionContext()));
    ...
    public void shouldGetApiSubscribersNotAsPrimaryOwner() {
        ...
        subC1.setApplication("C");
        subC1.setApi(API);
        doReturn(Arrays.asList(subA1, subC1)).when(subscriptionService).search(any(), eq(GraviteeContext.getExecutionContext()));
        ...
        Mockito.verify(subscriptionService).search(queryCaptor.capture(), eq(GraviteeContext.getExecutionContext()));
    ...
    public void shouldGetNoSubscribers() {
        doReturn(Collections.emptyList()).when(subscriptionService).search(any(), eq(GraviteeContext.getExecutionContext()));
